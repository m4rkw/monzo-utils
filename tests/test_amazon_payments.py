...
class TestAmazonPayments(BaseTest):
    ...
    def test_data_fields(self, mock_query, mock_db):
        ...
        self.assertEqual(data['payment_type'], 'Amazon Payments')
    ...
    def test_data_abbreviated(self, mock_query, mock_db):
        ...
        self.assertEqual(data['name'], 'payment')
        self.assertEqual(data['payment_type'], 'AP')
        self.assertEqual(data['remaining'], 123)
        self.assertEqual(data['status'], 'PAID')
        self.assertEqual(data['suffix'], '0/5')
    ...
    def test_display(self, mock_print, mock_query, mock_db):
        ...
        mock_print.assert_called_with('SKIPPED: Amazon Payments payment                   0/5   £24.60              £123.00               2024-02-01')


    @patch('monzo_utils.lib.db.DB.__init__')
    @patch('monzo_utils.lib.db.DB.query')
    @patch('builtins.print')
    @patch('monzo_utils.model.amazon_payments.AmazonPayments.last_payment', new_callable=PropertyMock)
    def test_display_last_amount_override(self, mock_last_payment, mock_print, mock_query, mock_db):
        ...
        with freeze_time('2024-01-22'):
            ...
            mock_print.assert_called_with('   PAID: Amazon Payments payment                   0/5   £2020.00            £123.00  2024-01-01   2024-02-01')
    ...
    @patch('monzo_utils.lib.db.DB.__init__')
    @patch('monzo_utils.lib.db.DB.query')
    @patch('monzo_utils.model.amazon_payments.AmazonPayments.yearly_payment_due_this_month')
    ...
    @patch('monzo_utils.lib.db.DB.__init__')
    @patch('monzo_utils.lib.db.DB.query')
    @patch('monzo_utils.model.amazon_payments.AmazonPayments.last_date', new_callable=PropertyMock)
    ...
    @patch('monzo_utils.lib.db.DB.__init__')
    @patch('monzo_utils.lib.db.DB.query')
    @patch('monzo_utils.model.amazon_payments.AmazonPayments.due_date', new_callable=PropertyMock)
    ...
    def test_payment_type(self, mock_query, mock_db):
        ...
        self.assertEqual(p.payment_type, 'Amazon Payments')
    ...
    @patch('monzo_utils.lib.db.DB.query')
    @patch('monzo_utils.model.amazon_payments.AmazonPayments.last_payment', new_callable=PropertyMock)
    @patch('monzo_utils.model.amazon_payments.AmazonPayments.older_last_payment', new_callable=PropertyMock)
    ...
    @patch('monzo_utils.model.amazon_payments.AmazonPayments.get_transaction_where_condition')
    ...
    def test_due_date__all_paid(self, mock_all_finance_transactions, mock_query, mock_db):
        mock_db.return_value = None
    ...
    @patch('monzo_utils.lib.db.DB.__init__')
    @patch('monzo_utils.lib.db.DB.query')
    @patch('monzo_utils.model.amazon_payments.AmazonPayments.all_finance_transactions', new_callable=PropertyMock)
