...
class TestDirectDebit(BaseTest):
    ...
    def test_data_fields(self, mock_query, mock_db):
        ...
        self.assertEqual(data['payment_type'], 'Direct Debit')
    ...
    def test_data_abbreviated(self, mock_query, mock_db):
        ...
        self.assertEqual(data['name'], 'payment')
        self.assertEqual(data['payment_type'], 'DD')
        self.assertEqual(data['remaining'], None)
        self.assertEqual(data['status'], 'PAID')
        self.assertEqual(data['suffix'], '')
    ...
    def test_display(self, mock_print, mock_query, mock_db):
        ...
        mock_print.assert_called_with('    DUE: Direct Debit    payment                         £123.00                                   ')
    ...
    def test_display_last_amount_override(self, mock_print, mock_query, mock_db):
        ...
        with freeze_time('2024-01-22'):
            ...
            mock_print.assert_called_with('    DUE: Direct Debit    payment                         £2020.00 ->£123.00                        ')
    ...
    @patch('monzo_utils.lib.db.DB.__init__')
    @patch('monzo_utils.lib.db.DB.query')
    @patch('monzo_utils.model.direct_debit.DirectDebit.yearly_payment_due_this_month')
    ...
    @patch('monzo_utils.lib.db.DB.__init__')
    @patch('monzo_utils.lib.db.DB.query')
    @patch('monzo_utils.model.direct_debit.DirectDebit.last_date', new_callable=PropertyMock)
    ...
    @patch('monzo_utils.lib.db.DB.__init__')
    @patch('monzo_utils.lib.db.DB.query')
    @patch('monzo_utils.model.direct_debit.DirectDebit.due_date', new_callable=PropertyMock)
    ...
    def test_payment_type(self, mock_query, mock_db):
        ...
        self.assertEqual(p.payment_type, 'Direct Debit')
    ...
    @patch('monzo_utils.lib.db.DB.query')
    @patch('monzo_utils.model.direct_debit.DirectDebit.last_date', new_callable=PropertyMock)
    @patch('monzo_utils.model.direct_debit.DirectDebit.last_payment', new_callable=PropertyMock)
    ...
    @patch('monzo_utils.lib.db.DB.query')
    @patch('monzo_utils.model.direct_debit.DirectDebit.last_payment', new_callable=PropertyMock)
    @patch('monzo_utils.model.direct_debit.DirectDebit.older_last_payment', new_callable=PropertyMock)
    ...
    @patch('monzo_utils.model.direct_debit.DirectDebit.get_transaction_where_condition')
